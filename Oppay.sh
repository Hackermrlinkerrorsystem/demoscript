...
echo -e $bu  " Tools       : Mrlinkerrorssytem$white      " 
echo -e $bu  " Author      : All Master Termux etc$white  " 
echo -e $bu  " Contact     : 081249281*** $white " 
...
echo -e $g "   [21] Cara Guna Tool/Tutorial Singkat😑" ;
...
21)echo -e $bu"Stok Habis mau order chat admin +6281249281196"

;;
0) echo -e $bu"KHO  -" 
echo -e $bu"THANK'S"
printf "\e[103m\e[1;77mBY; MRLINKERRORSYSTEM\e[0m\n"
sleep 2
exit
;;
